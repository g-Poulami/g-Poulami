...
- **[somatic-variant-calling](https://github.com/g-Poulami/somatic-variant-calling)**: detection of somatic mutations in tumour-normal pairs following GATK best practices, implemented as a reproducible Python-driven workflow.
- **[crispr-screen-reanalysis](https://github.com/g-Poulami/crispr-screen-reanalysis)**: reanalysis of pooled CRISPR screen data in Python, recovering gene-level essentiality and hit-calling from raw count data.
...
- **[Somatic-Variant-Calling-Project](https://github.com/g-Poulami/Somatic-Variant-Calling-Project)**: a Nextflow workflow for somatic mutation detection in tumour-normal pairs, orchestrating alignment, pre-processing, and variant calling with containerised, reproducible execution.
