...
| **Bioinformatics** | Nextflow, Snakemake, BWA, STAR, Samtools, Multi-omics integration |
| **Infrastructure** | AWS (EC2, S3), Linux/HPC (BlueBEAR), Docker, CI/CD |
| **Visualization** | Tableau, Chart.js, HTML, ggplot2 |
...
*   **LinkedIn**: [linkedin.com/in/poulami-ghosh-879439304](https://www.linkedin.com/in/poulami-ghosh-879439304)
*   **Google Scholar**: [Poulami Ghosh](https://scholar.google.com)
